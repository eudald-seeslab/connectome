...
from connectome.randomizers.generator import generate_random_connectome
from trainyourfly.utils.utils import update_config_with_sweep

from configs.sweep_definitions import SWEEP_DEFS
from training.sweep_utils import validate_sweep_config
...
def train(sweep_cfg=None):
    tracker = WandBTracker(project=project_name)
    with wandb.init(config=sweep_cfg):
        ...
        tracker.update_full_config(u_config)
